...
const DEMO_BOOKED = {
  photobooth: { "2025-08-05": 2, "2025-08-12": 1, "2025-08-19": 2, "2025-08-26": 1 },
  instax: { "2025-08-07": 1, "2025-08-14": 1, "2025-08-21": 1 },
};
...
function CalPage({ lang, serviceId, onNext, onBack }) {
  ...
  function getSlots(d) {
    ...
    var booked = (DEMO_BOOKED[serviceId] || {})[key] || 0;
...
// ── Page 6: Details Form ───────────────────────────────────────────────────────
function DetPage({ lang, serviceId, pkg, addOns, onNext, onBack }) {
  var t = T[lang];
  var svc = SERVICES[serviceId];
  var F = t.bodyFont;
  var [n, setN] = useState("");
  ...
  return (
    <div className="page-narrow" dir={t.dir} style={{ fontFamily: F }}>
      ...
      <button
        ...
        style={{ fontFamily: F }}
        onClick={function() { if (validate()) onNext({ fullName: n, phone: p, location: l }); }}
      >
        {t.continueConfirm}
      </button>
